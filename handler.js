...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.wm = '⁺◛˖Falz Botz'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'Falz Ganz'
        global.kontak2 = [
        ['6289518022967', 'FalzGanz', '𝙿𝚎𝚗𝚐𝚎𝚖𝚋𝚊𝚗𝚐', 'Gak donasi Gak papa asal bantu follow ig ku rifalstore_17', true],
        ['6289518022967', await this.getName('6285828357727@s.whatsapp.net'), '𝑷𝒂𝒓𝒕𝒏𝒆𝒓 FalzGanz', true], 
        ]
